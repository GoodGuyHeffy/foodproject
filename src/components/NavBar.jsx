    ...
    <div className='max-w-screen mx-auto flex justify-between items-center p-4'>
      ...
      <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2 font-bold'>
            Boro <span className='font-bold text-rose-500'>Bites</span>
        </h1>
     ...
     {/* Side drawer Menu */}
         ...
         <div className={nav ? "fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300" : "fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300"}>
          <AiOutlineClose size={30} className='absolute right-4 top-4 cursor-pointer'  onClick={()=> setNav(!nav)}/>
           <h2 className='text-2xl p-4'>Boro <span className='font-bold text-rose-500'>Bites</span></h2>
            ...
            <nav>
                <ul className='flex flex-col p-4 text-gray-800'>
                    ...
                    <li className='text-xl py-4 flex'><MdOutlineLocationSearching size={25} className='mr-4'/>Locations</li>
