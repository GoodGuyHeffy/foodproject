    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-2 gap-6'>
        ...
        <div className='rounded-xl relative'>
            ...
            <div className='absolute w-full h-full bg-black/40 rounded-xl text-white'>
              ...
              <Link to='/food'><button className='border-white bg-white text-black mx-2 absolute bottom-4 font-bold hover:bg-blue-500 hover:text-white hover:scale-105 duration-300 border-none'>View Menu</button></Link>
            </div>
         ...
         <div className='rounded-xl relative'>
            ...
            <div className='absolute w-full h-full bg-black/40 rounded-xl text-white'>
              ...
              <Link to='favorites'><button className='border-white bg-white text-black mx-2 absolute bottom-4 font-bold hover:bg-blue-500 hover:text-white hover:scale-105 duration-300 border-none'>View Menu</button></Link>
            </div>
